...
8. **Multi-branch.** Three branches are active (`Noch - City Walk`, `Noch - Gallery Mall`, `Bloom`). All three appear in shared branch selectors and branch-aware reporting.
