...
- Continue expense-to-journal checks outside 1–25 September and branch-level reporting over a wider date range. Prepare a reviewed sales-to-accounting backfill plan; do not run a blind posting job.
