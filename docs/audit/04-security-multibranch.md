...
🟠 **C2.** Profiles do not have a `branch_id` (or `assigned_branches[]`) column referenced anywhere in the audited POS module. There is **no concept** of "this barista works at Hay Al-Andalus." Multi-branch scaling needs this.
