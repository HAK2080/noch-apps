...
**Goal:** side-by-side branch metrics — Hay Al-Andalus vs Gallery Mall vs Bloom Abu Nawas. **Why now:** owner has 3 branches now. **Complexity:** S–M. **Dependencies:** existing `pos_sales_daily` view already does this.
