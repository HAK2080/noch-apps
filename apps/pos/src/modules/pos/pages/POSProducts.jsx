...
import { ArrowLeft, Plus, Edit2, Trash2, Package, Tag, GripVertical, LayoutList, Grid2X2, Copy, Globe } from 'lucide-react'
import {
  getPOSBranch, getPOSBranches, getPOSProducts, getPOSCategories,
  deletePOSProduct, deletePOSCategory, updatePOSProduct, updatePOSCategory,
    ...
    <Layout>
      ...
      {showShare && (
        <ShareMenuModal
          ...
          onDone={() => { setShowShare(false); load() }}
