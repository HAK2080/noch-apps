...
import { ArrowLeft, Plus, Edit2, Trash2, Package, Tag, Globe, GripVertical, LayoutList, Grid2X2, Copy } from 'lucide-react'
import {
  getPOSBranch, getPOSBranches, getPOSProducts, getPOSCategories,
  updatePOSProduct, deletePOSProduct,
  updatePOSCategory, deletePOSCategory,
