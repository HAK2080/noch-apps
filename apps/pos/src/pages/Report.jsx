...
const REPORT_COPY = {
  en: {
    ...
    cash: 'Cash net',
    cashSub: 'After cash refunds; includes split payments',
    card: 'Card net',
    cardSub: 'After card refunds; includes split payments',
    ...
    paymentNetSales: 'POS payment movement',
  ...
  ar: {
    ...
    cash: 'صافي النقدي',
    cashSub: 'بعد المرتجعات ويشمل المدفوعات المقسمة',
    card: 'صافي البطاقات',
    cardSub: 'بعد المرتجعات ويشمل المدفوعات المقسمة',
    presto: 'مدفوعات بريستو',
    prestoSub: 'طلبات بريستو',
    other: 'طرق دفع أخرى',
    otherSub: 'وسائل دفع بديلة أو غير مصنفة',
    completedSales: 'إجمالي المبيعات المكتملة',
    paymentNetSales: 'صافي حركة مدفوعات نقطة البيع',
