...
-- Customer-memory fields, passport tokens, public read RPC, and
-- POS visit recorder. Re-runnable.
-- ============================================================
...
-- Public Passport read — anon-safe, whitelisted fields, no phone.
...
-- POS visit recorder — bumps last_visit_at, increments total_visits
-- once per 2-hour window, backfills favorite_drink only when null.
