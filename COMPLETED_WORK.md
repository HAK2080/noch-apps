...
- **Status**: Implemented and verified locally. Not pushed, not deployed; migration not yet applied to production.
...
- **Commit / deployment**: Committed on `feat/expense-auto-approval-pos-instance-lock`. Not pushed, not deployed, production not verified — these remain open per repository policy.
