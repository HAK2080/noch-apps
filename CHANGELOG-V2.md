...
## 3.5.0 — 2026-04-24
Anchored fresh working copy from cross-machine transfer (was 3.4.0). New home: `C:\Users\aeroh\AI apps\Noch_apps_May_2026\`. Old 3.2.0 tree preserved under `_archive\noch-task-manager-main-v3.2.0\`. Local-only files carried over: `.env`, `.env.example`, `.gitignore`, `.deploy-apps.py`, `.deploy-runner.py`, `.clone`, deploy zips, `.claude/settings.local.json`.
